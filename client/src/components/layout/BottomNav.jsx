...
const BottomNav = ({ onSearchClick }) => {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 px-6 py-3 z-50 shadow-[0_-8px_20px_rgba(0,0,0,0.05)]">
      <div className="flex items-center justify-between max-w-md mx-auto">
        ...
        >
          ...
          <span className="text-[10px] font-black text-blue-600 mt-1 uppercase tracking-tighter">Admin</span>
        </NavLink>
